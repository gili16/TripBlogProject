...
namespace MyProject.WebApi.Controllers
{
    ...
    {
        private readonly OptionTypeService<Status, StatusDto> service;
        public StatusController(OptionTypeService<Status, StatusDto> service)
        {
        ...
        public async Task<ActionResult> Post([FromBody] StatusDto statusDto)
        {
            try
            {
                return Ok(await service.AddItemAsync(statusDto));
            }
            catch (Exception e)
            {
                return BadRequest(e.Message);
        ...
        public async Task<ActionResult> Put(int id, [FromBody] StatusDto statusDto)
        {
            try
            {
                await service.UpdateItem(id, statusDto);
                return Ok();
            }
            catch (Exception e)
            {
